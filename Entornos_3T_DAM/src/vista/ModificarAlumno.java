...
public class ModificarAlumno extends JPanel {
	...
	public ModificarAlumno() {
		...
		btnBuscar.addActionListener(new ActionListener() {
			/**
			 * Con el m�todo de buscar, hacemos que el usuario a la hora de pulsarlo se
			 * proceda ha realizar la b�squeda.
			 */
		...
		btnModificar.addActionListener(new ActionListener() {
			/**
			 * Con el bot�n de modificar, a la hora que el usuario lo pulse, le saltar� una
			 * alerta de advertencia, si est� seguro de modificar los siguientes datos que
