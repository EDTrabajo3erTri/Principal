...
public class ModificarAlumno extends JPanel {
	...
	public ModificarAlumno() {
		...
		txtpnBorrarAlumno.setText("Modificar Alumno");
		...
		scrollPane.setViewportView(table);
				...
				lblNewLabel_2_3.setBounds(32, 388, 138, 20);
				add(lblNewLabel_2_3);
				...
				lblNewLabel_2_4_1_1.setBounds(424, 357, 138, 20);
				add(lblNewLabel_2_4_1_1);
				
				textField_4 = new JTextField();
				textField_4.setColumns(10);
				textField_4.setBounds(572, 360, 192, 20);
				add(textField_4);
				...
				textField_7.setBounds(180, 388, 192, 20);
				add(textField_7);
	}
}
